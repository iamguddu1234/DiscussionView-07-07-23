  ...
  <TicketNavBar/>
    ...
    <div className={classes.parentDiv}>
      ...
      <div className={classes.descriptionDetails}>
        ...
        Compound? When two or more elements chemically combine in a fixed ratio
        by mass, the obtained product is known as a compound.
      </div>
      ...
      <div className={classes.commnetSection}>
        ...
        <div className={classes.writeCommentSection}>
          ...
          <div className={classes.buttonContainer}>
            <button className={classes.postCommentButton}>Post Comment</button>
